...
const API_URL = `${BACKEND_URL}/api/iptv`;
...
export function LiveTV() {
    ...
    return (
        <div className="min-h-screen bg-background pt-20 flex">
            ...
            <div className="md:hidden fixed top-20 left-0 right-0 z-40 border-b border-white/5 bg-black/80 backdrop-blur-xl">
                <div className="px-4 py-3 space-y-3">
                    <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0">
                            ...
                            <p className="text-[10px] text-gray-500">
                                {channels.length} canais • {selectedGroup === 'All' ? 'todos os grupos' : selectedGroup}
                            </p>
                        </div>
                        <div className="flex items-center gap-2">
                            <Button
                                ...
                                variant="outline"
                                className="h-9 px-3 text-[10px] border-green-500/30 text-green-400 hover:bg-green-500/10"
                            >
                            ...
                            <Button
                                ...
                                variant="outline"
                                className="h-9 px-3 text-[10px] border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/10"
                            >
                    ...
                    <div className="relative group">
                        ...
                        <Input
                            ...
                            className="pl-10 pr-10 bg-black/50 border-white/10 text-sm h-10 focus:border-cyan-500/50 transition-all"
                        />
                        {searchQuery && (
                            <button
                    ...
                    <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1">
                        <button
                            ...
                            className={cn(
                                ...
                                selectedGroup === 'All' ? "bg-cyan-500/20 text-cyan-400 border border-cyan-500/30" : "bg-white/5 text-gray-400 border border-white/10"
                            )}
                        >
                            Todos
                        </button>
                        <button
                            onClick={() => setSelectedGroup('â­ PADRÃƒO')}
                            className={cn(
                                "px-3 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider whitespace-nowrap transition-all",
                                selectedGroup === 'â­ PADRÃƒO' ? "bg-yellow-500/20 text-yellow-400 border border-yellow-500/30" : "bg-white/5 text-yellow-400/70 border border-yellow-500/20"
                            )}
                        >
                            PadrÃ£o
                        </button>
                        {groups.filter(group => group !== 'All').slice(0, 12).map(group => (
                            <button
                                key={group}
                                onClick={() => setSelectedGroup(group)}
                                className={cn(
                                    "px-3 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider whitespace-nowrap transition-all",
                                    selectedGroup === group ? "bg-cyan-500/20 text-cyan-400 border border-cyan-500/30" : "bg-white/5 text-gray-400 border border-white/10"
                                )}
                            >
                                {group}
                            </button>
                    ...
                    <div className="flex gap-2">
                        <Button
                            ...
                            variant="outline"
                            className="flex-1 h-9 text-[10px] border-purple-500/30 text-purple-400 hover:bg-purple-500/10"
                        >
                        ...
                        <Button
                            ...
                            variant="ghost"
                            className="flex-1 h-9 text-[10px] text-gray-400 hover:text-white"
                        >
            ...
            {/* MAIN CONTENT */}
            <main className="flex-1 ml-0 md:ml-72 flex flex-col pt-[10.5rem] md:pt-0">

                {/* VIDEO PLAYER */}
                <div className="h-[34vh] sm:h-[42vh] md:h-[55vh] bg-black relative group">
                    <video
                        ref={videoRef}
                    ...
                    {selectedChannel ? (
                        <div className="absolute top-3 left-3 sm:top-4 sm:left-4 z-10 pointer-events-none">
                            <div className="bg-black/60 backdrop-blur-md px-3 sm:px-4 py-2 rounded-xl border border-white/10">
                                <h3 className="text-white font-bold text-sm sm:text-lg">{selectedChannel.name}</h3>
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 to-black text-center p-6">
                            ...
                            <h2 className="text-xl sm:text-2xl font-black text-white uppercase italic tracking-widest mb-2">
                    ...
                    {/* Custom Controls */}
                    <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 flex gap-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity z-10">
                        <button
                ...
                <div className="flex-1 overflow-hidden flex flex-col bg-gradient-to-b from-black to-background">
                    ...
                    {/* Category Header */}
                    <div className="px-4 sm:px-6 py-3 border-b border-white/5 flex justify-between items-center gap-3 bg-black/40">
                        <h3 className="font-display text-white text-xs sm:text-sm uppercase tracking-wider flex items-center gap-2 min-w-0">
                            <Radio size={14} className="text-cyan-400" />
                            <span className="truncate">{selectedGroup === 'All' ? 'TODOS OS CANAIS' : selectedGroup}</span>
                        </h3>
                ...
                {showRecommended && (
                    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
                        <motion.div
                            ...
                            className="bg-[#0a0a0b] rounded-2xl p-4 sm:p-6 w-full max-w-5xl border border-white/10 shadow-2xl max-h-[85vh] flex flex-col"
                        >
                ...
                {showHistory && (
                    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
                        <motion.div
                            ...
                            animate={{ scale: 1, opacity: 1 }}
                            exit={{ scale: 0.9, opacity: 0 }}
                            className="bg-[#0a0a0b] rounded-2xl p-4 sm:p-6 w-full max-w-2xl border border-white/10 shadow-2xl max-h-[80vh] flex flex-col"
                        >
                            <div className="flex justify-between items-center mb-6">
                                <div>
                ...
                {showUpload && (
                    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
                        <motion.div
                            ...
                            animate={{ scale: 1, opacity: 1 }}
                            exit={{ scale: 0.9, opacity: 0 }}
                            className="bg-[#0a0a0b] rounded-2xl p-4 sm:p-6 w-full max-w-lg border border-white/10 shadow-2xl"
                        >
                            <div className="flex justify-between items-center mb-6">
                                <div>
