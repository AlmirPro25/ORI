        ...
        <div className="min-h-screen bg-black text-gray-100 p-4 md:p-8 pt-24 font-mono selection:bg-cyan-500/30">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-cyan-900/50 pb-8">
                    <div className="space-y-2">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-3xl md:text-5xl font-black bg-gradient-to-r from-white via-cyan-400 to-blue-600 bg-clip-text text-transparent tracking-tighter">
                                ORION CORE
                            </h1>
                        </div>
                    ...
                    <div className="flex flex-wrap gap-4">
                        <div className="px-5 py-2 bg-cyan-950/20 border border-cyan-500/30 rounded-xl backdrop-blur-md flex items-center gap-3">
                        ...
                        <div className="px-5 py-2 bg-purple-950/20 border border-purple-500/30 rounded-xl backdrop-blur-md flex items-center gap-3">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 group relative h-[500px] bg-gray-950 border border-gray-900 rounded-3xl overflow-hidden flex items-center justify-center">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex-1 p-8 bg-gray-900/40 border border-gray-800 rounded-3xl backdrop-blur-xl space-y-6 flex flex-col">
