...
export const TorrentPlayerPage: React.FC = () => {
    ...
    return (
        <motion.div
            ...
            className="min-h-screen bg-background pt-32 pb-20 px-4 md:px-12 relative overflow-hidden"
        >
            {/* Ambient FX */}
            ...
            <div className="max-w-7xl mx-auto space-y-12">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 pb-8 border-b border-white/5">
                    <div className="flex items-start gap-6">
                        <button
                            onClick={() => navigate(-1)}
                            className="p-4 bg-white/5 hover:bg-white/10 rounded-[1.5rem] border border-white/5 text-gray-400 hover:text-primary transition-all group"
                        >
                    ...
                    <div className="flex gap-4">
                        <button className="flex items-center gap-2 px-6 py-3 bg-white/5 border border-white/10 rounded-2xl text-[10px] font-black uppercase tracking-widest text-white/60 hover:text-white hover:bg-white/10 transition-all">
                ...
                <div className="relative group">
                    ...
                    <div className="relative aspect-video rounded-[2.5rem] overflow-hidden border border-white/10 bg-black/40 backdrop-blur-3xl shadow-2xl">
                        <TorrentPlayer
                            magnetURI={magnetURI}
                            videoId={videoId}
                        />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="md:col-span-2 glass-card p-10 rounded-[2.5rem] flex items-start gap-8">
                        <div className="w-16 h-16 bg-primary/10 rounded-3xl flex-shrink-0 flex items-center justify-center text-primary border border-primary/20">
                            <Info size={32} />
                        </div>
                        <div className="space-y-3">
                            <h4 className="text-xl font-black text-white uppercase italic tracking-tight">Decentralized Streaming Protocol</h4>
                    ...
                    <div className="glass-card p-10 rounded-[2.5rem] flex flex-col justify-center gap-4 text-center">
                        <div className="text-4xl font-black text-primary">4K</div>
