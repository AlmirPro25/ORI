...
export const AdminPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-background pt-24 pb-20 px-4 sm:px-6 md:px-12">
            {/* Admin Header */}
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                ...
                <div className="flex flex-wrap gap-3">
                    <div className="bg-white/5 p-3 sm:p-4 rounded-2xl border border-white/5 grid grid-cols-2 sm:flex sm:items-center gap-4 sm:gap-6 shadow-2xl backdrop-blur-md w-full md:w-auto">
            ...
            {/* Video Table */}
            {currentTab === 'VIDEOS' && (
                <div className="bg-white/5 rounded-2xl md:rounded-3xl border border-white/5 overflow-hidden shadow-2xl">
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-white/5 bg-white/[0.02]">
                                    <th className="px-4 md:px-6 py-4 text-[10px] font-black uppercase tracking-widest text-gray-500">Preview / Título</th>
                                    <th className="px-4 md:px-6 py-4 text-[10px] font-black uppercase tracking-widest text-gray-500">Categoria</th>
                                    <th className="px-4 md:px-6 py-4 text-[10px] font-black uppercase tracking-widest text-gray-500">Status</th>
                                    <th className="px-4 md:px-6 py-4 text-[10px] font-black uppercase tracking-widest text-gray-500">Data</th>
                                    <th className="px-4 md:px-6 py-4 text-[10px] font-black uppercase tracking-widest text-gray-500 text-right">Ações</th>
                                </tr>
                            </thead>
                                ...
                                <AnimatePresence mode="popLayout">
                                    {filteredVideos.map((video) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 md:px-6 py-4">
                                                    <span className="px-2 py-1 bg-white/5 border border-white/10 rounded text-[10px] font-bold text-gray-400 uppercase tracking-[0.18em] md:tracking-widest whitespace-nowrap">
