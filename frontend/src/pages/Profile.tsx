            ...
            <div className="container mx-auto px-6 max-w-5xl">
                ...
                >
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-white/5 border border-white/10 rounded-[2rem] p-8 text-center relative overflow-hidden backdrop-blur-xl shadow-2xl">
                            ...
                            <h2 className="text-2xl font-black uppercase italic tracking-tight mb-1">{user.name}</h2>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <div className="bg-white/5 border border-white/10 rounded-[2rem] p-10 backdrop-blur-xl relative overflow-hidden">
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <Button
                                    ...
                                    className={cn(
                                        "h-12 px-6 rounded-xl font-bold uppercase tracking-widest text-xs transition-all border",
                                        isEditing
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <Input
                                            ...
                                            disabled={!isEditing}
                                            className="pl-12 h-14 bg-black/20 border-white/10 rounded-xl text-white disabled:opacity-50 disabled:cursor-not-allowed focus:border-primary/50 transition-all font-medium"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <Input
                                            ...
                                            value="********"
                                            disabled
                                            className="pl-12 h-14 bg-black/20 border-white/10 rounded-xl text-white disabled:opacity-50 disabled:cursor-not-allowed font-medium"
                                        />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            value={user.id}
                                            disabled
                                            className="pl-12 h-14 bg-black/20 border-white/10 rounded-xl text-white/50 font-mono text-xs opacity-70"
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-[2rem] p-10 backdrop-blur-xl">
                            ...
                            <div className="space-y-4">
                                {[1, 2, 3].map((_, i) => (
                                    <div key={i} className="flex items-center gap-4 p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors border border-transparent hover:border-white/10 group cursor-pointer">
