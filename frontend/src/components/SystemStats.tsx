...
export const SystemStats: React.FC = () => {
    ...
    const StatCard = ({ icon: Icon, label, value, color, subtitle }: any) => (
        <motion.div
            ...
            className={`bg-gradient-to-br ${color} rounded-2xl p-5 border border-white/10 shadow-xl`}
        >
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-background pt-32 pb-12 px-6 md:px-12 flex items-center justify-center">
