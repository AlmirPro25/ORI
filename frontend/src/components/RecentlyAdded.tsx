...
export const RecentlyAdded: React.FC = () => {
    ...
    return (
        <div className="px-4 sm:px-6 md:px-16 py-10 md:py-16 relative overflow-hidden">
            ...
            <div className="flex items-center gap-4 md:gap-6 mb-8 md:mb-12">
                ...
                <div>
                    ...
                    <p className="text-[9px] md:text-[10px] text-white/30 font-black uppercase tracking-[0.22em] md:tracking-[0.4em] mt-1 ml-0.5">Novidades reais e prateleiras vivas</p>
                </div>
            </div>

            <div className="flex gap-3 sm:gap-5 overflow-x-auto pb-8 md:pb-12 no-scrollbar snap-x snap-mandatory">
