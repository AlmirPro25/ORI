                ...
                {isOpen && (
                    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
                        ...
                        <motion.div
                            ...
                            className="relative z-10 w-full max-w-2xl bg-gray-900 border border-white/10 rounded-3xl shadow-2xl overflow-hidden"
                        >
                            <div className="p-6 border-b border-white/10 bg-black/40">
                                ...
                                <div className="mt-4 flex gap-2">
                                    ...
                                    <button
                                        ...
                                        disabled={loading}
                                        className="px-6 bg-primary text-black font-bold rounded-xl hover:bg-white transition-colors disabled:opacity-50"
                                    >
                            ...
                            <div className="max-h-[400px] overflow-y-auto p-4 space-y-2">
                                ...
                                {!loading && subtitles.map((sub) => (
                                    <motion.div
                                        ...
                                        className="group p-4 bg-white/[0.02] hover:bg-white/[0.05] border border-white/5 hover:border-primary/30 rounded-2xl transition-all cursor-pointer"
                                    ...
                                    >
                                        <div className="flex items-center justify-between gap-4">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <button
                                                    className="p-3 bg-primary/10 group-hover:bg-primary text-primary group-hover:text-black rounded-xl transition-all opacity-0 group-hover:opacity-100"
                                                    onClick={() => handleDownload(sub)}
                                                >
                                                    <Download size={16} />
                                                </button>
