...
export const Footer: React.FC = () => {
    return (
        <footer className="bg-black/80 backdrop-blur-xl border-t border-white/5 pt-16 pb-8 px-6 md:px-12 relative z-10">
            ...
            <div className="max-w-7xl mx-auto pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] text-gray-500 font-mono uppercase tracking-[0.2em]">
