        ...
        <>
            ...
            {!isOpen && (
                <motion.button
                    ...
                    className="sticky bottom-4 right-4 ml-4 mb-4 z-[9999] w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full shadow-2xl flex items-center justify-center hover:scale-110 transition-transform"
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className={`fixed bottom-20 right-3 left-3 sm:left-auto sm:right-6 z-[9999] bg-black/95 backdrop-blur-xl border border-purple-500/30 rounded-2xl shadow-2xl flex flex-col overflow-hidden transition-all ${isCompact ? 'h-56 sm:w-56' : 'h-[72vh] max-h-[36rem] sm:w-72 sm:h-96'
                            }`}
                        style={{ position: 'fixed' }}
                    >
                        {/* Header */}
                        <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border-b border-purple-500/30 p-3 flex items-center justify-between gap-3">
                        ...
                        <div className="flex-1 overflow-y-auto p-3 space-y-3">
                            ...
                            {messages.map((msg, i) => (
                                ...
                                >
                                    <div
                                        className={`max-w-[88%] sm:max-w-[80%] rounded-2xl px-3 py-2 ${msg.role === 'user'
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {quickActions.map((action, i) => (
                                        <button
                                            ...
                                            className="min-h-[72px] bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-lg p-2 hover:from-purple-500/30 hover:to-pink-500/30 transition-all"
                                        >
