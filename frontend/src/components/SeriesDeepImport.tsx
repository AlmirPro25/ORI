                ...
                <div className="flex gap-4">
                    <div className="flex-1 relative">
                        <Input
                            ...
                            className="bg-black/40 border-white/10 h-14 pl-6 pr-12 rounded-2xl text-white placeholder:text-white/20"
                        />
                        {exploring && (
                    ...
                    <Button
                        ...
                        className="h-14 px-8 rounded-2xl bg-primary text-black font-black uppercase tracking-widest hover:bg-primary/90 transition-all shadow-glow"
                    >
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-3xl p-8 relative overflow-hidden">
                            ...
                            <div className="relative space-y-6">
                                <div>
                                    ...
                                    <h3 className="text-xl font-bold text-white max-w-2xl leading-tight">{metadata.name}</h3>
                                    <p className="text-[10px] font-mono text-white/30 mt-2 uppercase tracking-tighter truncate max-w-xl">{metadata.infoHash}</p>
                                </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xl font-bold">{metadata.totalFiles}</p>
                                    </div>
                                    <div className="space-y-1">
                                        <p className="text-[9px] font-black text-primary uppercase tracking-widest">Episódios Detectados</p>
                                        <p className="text-xl font-bold text-primary">{metadata.suggestedEpisodes.length}</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-3xl overflow-hidden">
                                    ...
                                    <div key={idx} className="p-4 flex items-center gap-4 hover:bg-white/[0.02] transition-colors group">
                                        ...
                                        <div className="flex-1 min-w-0 space-y-1">
                                            ...
                                            <div className="flex items-center gap-3 text-[10px] font-mono text-white/30">
                                                <span className="flex items-center gap-1.5 truncate max-w-[300px]" title={ep.path}>
                            ...
                            <div className="p-6 bg-white/[0.02] border-t border-white/5">
                                <Button
                                    ...
                                    className="w-full h-14 bg-primary text-black font-black uppercase tracking-widest hover:scale-[1.01] transition-all shadow-glow flex items-center justify-center gap-2"
                                >
