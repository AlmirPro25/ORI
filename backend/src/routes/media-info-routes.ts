            ...
            if (v.audioTracks && v.subtitleTracks) {
                const mediaInfo = {
                    ...
                    detectionSummary: {
                        ...
                        portugueseAudioConfidence: v.hasDubbed ? 1 : 0,
                        portugueseSubtitleConfidence: v.hasPortuguese && !v.hasDubbed ? 0.7 : 0,
                        dubbedConfidence: v.hasDubbed ? 1 : 0,
                        subtitleConfidence: v.hasPortuguese && !v.hasDubbed ? 0.7 : 0,
                    },
                };
                badges = MediaInfoExtractor.generateBadges(mediaInfo);
            }
